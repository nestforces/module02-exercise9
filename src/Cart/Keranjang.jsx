            ...
            <Box key={item.id}>
              ...
              <Flex marginLeft='25px' justifyContent={'space-between'}>
                ...
                <Flex alignItems='center'>
                  ...
                  <Box>
                    <IconButton colorScheme='transparent' icon={<RiDeleteBin6Fill color='gray' />} onClick={() => dispatch(remove(item.id))} />
                  </Box>
                  <Box marginLeft='10px'>
                    <IconButton colorScheme='transparent' icon={<AiOutlineMinusCircle color='green' />} onClick={() => dispatch(decrement(item.id))} />
                  </Box>
                  ...
                  <Box>
                    <IconButton colorScheme='transparent' icon={<AiOutlinePlusCircle color='green' />} onClick={() => dispatch(increment(item.id))} />
                  </Box>
                </Flex>
              </Flex>
        ...
        >
          ...
          >
            ...
            <Flex justifyContent='space-between'>
              <Text color='blackAlpha.600' textAlign='left' id='totalbarang'>
                Total harga ({(getTotal().totalQuantity)} barang)
              </Text>
              <Text color='blackAlpha.600'>{formatPriceToIDR(getTotal().totalPrice)}</Text>
            </Flex>
          </Flex>
          ...
          >
            ...
            <Flex flexDirection={'row'} justifyContent={'space-between'} marginTop='5%'>
              ...
              <Text as='b' color='blackAlpha.700'>{formatPriceToIDR(getTotal().totalPrice)}</Text>
            </Flex>
            <Flex>
              <Button width={'100%'} colorScheme='green' marginTop={'5%'}>Beli ({getTotal().totalQuantity})</Button>
            </Flex>
          </Flex>
        </Flex>
      </Flex>
